...
namespace JY.DAL
{
	...
	public partial class ProductType
	{
		...
		public bool Exists(long ID)
		{
			...
			int result= DbHelperSQL.RunProcedure("ProductType_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		///  增加一条数据
		/// </summary>
		public long Add(JY.Model.ProductType model)
		{
			int rowsAffected;
			SqlParameter[] parameters = {
			...
			DbHelperSQL.RunProcedure("ProductType_ADD",parameters,out rowsAffected);
		...
		///  更新一条数据
		/// </summary>
		public bool Update(JY.Model.ProductType model)
		{
			int rowsAffected=0;
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt,8),
			...
			DbHelperSQL.RunProcedure("ProductType_Update",parameters,out rowsAffected);
			if (rowsAffected > 0)
			{
				return true;
			}
		...
		public bool Delete(long ID)
		{
			...
			DbHelperSQL.RunProcedure("ProductType_Delete",parameters,out rowsAffected);
			if (rowsAffected > 0)
			{
				return true;
			}
		...
		/// 得到一个对象实体
		/// </summary>
		public JY.Model.ProductType GetModel(long ID)
		{
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt)
			};
			...
			JY.Model.ProductType model=new JY.Model.ProductType();
			DataSet ds= DbHelperSQL.RunProcedure("ProductType_GetModel",parameters,"ds");
