...
namespace JY.DAL
{
	...
	public partial class UserInfo
	{
		...
		public bool Exists(long ID)
		{
			...
			int result= DbHelperSQL.RunProcedure("UserInfo_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public bool Delete(long ID)
		{
			...
			DbHelperSQL.RunProcedure("UserInfo_Delete",parameters,out rowsAffected);
			if (rowsAffected > 0)
			{
				return true;
			}
		...
		public JY.Model.UserInfo GetModel(long ID)
		{
			...
			DataSet ds= DbHelperSQL.RunProcedure("UserInfo_GetModel",parameters,"ds");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,UserName,Password,UserType,Remark,IsDelete ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,UserName,Password,UserType,Remark,IsDelete ");
			strSql.Append(" FROM UserInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
